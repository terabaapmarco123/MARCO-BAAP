...
if ((event.body.toLowerCase() == "Love you") || (event.body.toLowerCase() == "bot love u")) {
   ...
   if ((event.body.toLowerCase() == "julmi") || (event.body.toLowerCase() == "julmi jaat") || (event.body.toLowerCase() == "जुल्मी") || (event.body.toLowerCase() == "प्रिंस बेबी ")) {
   ...
   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "Owner")) {
     return api.sendMessage("💝🥀𝐎𝐖𝐍𝐄𝐑:-☞𝗣𝗥𝗜𝗡𝗖𝗘 𝗕𝗪𝗕'𝗜𝗜𝗘𝗪☜💫\n🖤𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 𝗣𝗥𝗜𝗡𝗖𝗘\n😳𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝🤓:- ☞ https://www.facebook.com/th.w.priinc.bwb.ii.w\n👋For Any Kind Of Help Contact On Instagram Username 👉https://instagram.com/_julmi_jaat__?igshid=OGQ5ZDc2ODk2ZA==😇", threadID);
   };

   if ((event.body.toLowerCase() == "tumhe banaya kon hai") || (event.body.toLowerCase() == "tumko banaya kisne")) {
     return api.sendMessage("𝘗𝘙𝘐𝘕𝘊𝘌 𝘉𝘞𝘉𝘐𝘐𝘌𝘞  ❤️ My Creator. He loves me & Edit Me Daily. Ye Bot Sirf Owner k Liye h. Mujhe Aap logo ko Hasane k liye banya gya h Toh Muh Ladkaye Mat Rakkha Karo. Har Waqt Haste Raho.", threadID);
   };
